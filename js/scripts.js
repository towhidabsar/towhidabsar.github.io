$(document).ready(function () {
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        // $.ajax({
        //     url: 'https://script.google.com/macros/s/AKfycbymCCzMa18igJ7XxuWsrirYyJ94tSxScfw-g5OKMRgTnyhtDzYqoNzGVyfFifOtsXs_/exec',
        //     method: "POST",
        //     dataType: "json",
        //     data: data,
...
// Google map 42.55025370559106, -83.0891959046735
function initMap() {
    var location = {lat: 42.55025370559106, lng: -83.0891959046735};
...
function initBBSRMap() {
    var la_fiesta = {lat: 42.55025370559106, lng: -83.0891959046735};
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 15,
        center: la_fiesta,
        scrollwheel: false
